...
#     //build_plugins/config/aosp/internal_rules.gni

# Some clients do not add //build_plugins/templates/java/util to PYTHONPATH.
...
def parse_gn_list(gn_string):
    ...
    The common use for this behavior is in the AOSP build where things can
